...
To check the correctness of your program, use a [suitable environment](https://github.com/essential-c/devcontainer) and write your solution in a file named **`pointer2.c`**. In a terminal, with that file in the local directory, check with this command:
