...
To check the correctness of your program, use a [suitable environment](../../README.md) and write your solution in a file named **`time.c`**. In a terminal, with that file in the local directory, check with this command:
