...
Write a C program that takes two integers as command line parameters, `x` and `y`, and prints on the standard output `x` lines of `y` integers corresponding to the first (`x * y`) natural integers.
